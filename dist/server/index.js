...
var sirvHandler;
async function init() {
  handleExports = await import("./assets/virtual_rakkasjs_node-handler-entry.223a8f24.js").then((n) => n.v);
  sirvHandler = build_default("dist/client", handleExports.sirvOptions);
  const PORT = Number(process.env.PORT) || 3e3;
  const HOST = process.env.HOST || "localhost";
  createServer((req, res) => sirvHandler(req, res, () => {
